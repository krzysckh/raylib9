...
int main(void)
{
    ...
    SetTargetFPS(600);
    Texture2D gt = LoadTexture("g.png");
    ...
    while (!WindowShouldClose())
    {
        ...
        BeginDrawing();
            ...
            BeginMode2D(camera);
                ...
                Rectangle r0 = {0,0,gt.width,gt.height};
                DrawRectangleRec(playerRect, RED);
                DrawTexturePro(gt, r0, playerRect, (Vector2){0,0}, 0.f, WHITE);
                DrawTexturePro(gt, r0, r0, (Vector2){0,0}, 0.f, WHITE);
